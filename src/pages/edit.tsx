...
const EditPage: React.FunctionComponent<IPageProps & RouteComponentProps<any>> = (props) => {
    ...
    return (
        <Container fluid className="p-0">
            <Header
                image="https://images.unsplash.com/photo-1488190211105-8b0e65b80b4e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
                headline=""
            ...
            <Container className="mt-5 mb-5">
                ...
                <Form>
                    ...
                    <FormGroup>
                        <Label for="picture" style={{ color: 'white' }}>
                            Picture URL
                        </Label>
                        <Input
                            type="text"
                    ...
                    <FormGroup>
                        <Label for="headline" style={{ color: 'white' }}>
                            Headline
                        </Label>
                        <Input
                            type="text"
