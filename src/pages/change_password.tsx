...
const ChangePasswordPage: React.FunctionComponent<IPageProps> = (props) => {
    ...
    return (
        <CenterPiece header="Change Password">
            <FormGroup>
                <Input autoComplete="new-password" type="password" name="oldPassword" id="oldPassword" placeholder="Current Password" onChange={(event) => setOld(event.target.value)} value={old} />
            </FormGroup>
            <FormGroup>
